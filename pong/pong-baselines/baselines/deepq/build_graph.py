...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        real_fake_label = tf.placeholder(tf.int32, [None], name = "real_fake")
        ...
        q_t, real_fake_logits = q_func(obs_t_input.get(), num_actions, scope="q_func", reuse=True)  # reuse parameters from act
