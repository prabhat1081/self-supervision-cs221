...
frames_per_video = 125

orig_dir = "original_images"
fake_dir = "fake_images"

orig_train_dir = "original_train_images1"
orig_test_dir = "original_test_images1"
		...
		if frame_idx%sample_idx == 0 :
			...
			if len(faces):
				...
				if not actor_idx in [25, 26, 27, 28] :
					...
					save_image(cropped_face, join(orig_train_dir, fname))
				else :
					save_image(cropped_face, join(orig_test_dir, fname))
